...
foreach csv_line_fields $values_list_of_lists {
    ...
    if {"" == $project_id} {
        if {$ns_write_p} {
            ns_write "<li><font color=red>Error: We have found an empty 'project_id' in line $cnt.<br>
                Please correct the CSV file. 'project_id' is mandatory.Skipping line!</font></li>"
        }
        continue
    }
    ...
    if { $conf_object_id_exist_p } {
       ns_write "<li>Merging hours: <font color=red>Conf Object exists, skipping project_id: $project_id, user_id: $user_id, day: $day</font></li>"
       continue
    }
	...
	if { !$test_run_p } {
		...
		<li>Merging hours: <font color=red>Conf Object exists, skipping project_id: $project_id, user_id: $user_id, day: $day</font></li>
	    }
	}
	ns_write "<li>Merging hours: project_id: $project_id, user_id: $user_id, day: $day</li>"	
    } 
